...
max_class = class_list[class_freq.index(max_freq)]
...
#devset
predictions_dev = [max_class for i in range(len(x_tups_dev))]

#testset
predictions_test = [max_class for i in range(len(x_tups_test))]
